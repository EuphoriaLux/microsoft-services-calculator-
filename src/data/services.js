...
const services = [
  ...
  },
  {
    ...
    description: 'End-to-end management of your cloud subscriptions, billing, and support through Microsoft\'s CSP program.',
    phase: 'implement',
    tech: 'azure',
    serviceType: 'managed',
    price: 3500,
  ...
  {
    id: 'azurecostoptimization-managed',
    name: 'Azure Cost Optimization',
    description: 'Ongoing analysis and optimization of Azure resources to maximize efficiency and reduce cloud spending.',
    phase: 'implement',
    tech: 'azure',
    serviceType: 'managed',
    price: 1500,
  ...
  },
  {
    ...
    description: 'Enterprise-grade technical support with dedicated account management, priority response times, and proactive services.',
    phase: 'implement',
    tech: 'security',
    serviceType: 'managed',
    hasTiers: true,
    tiers: [
      {
        id: 'bronze',
        name: 'Bronze',
        description: 'Basic support with standard SLAs and limited service hours.',
        price: 0,
      },
      {
        id: 'silver',
        name: 'Silver',
        description: 'Enhanced support with faster response times and extended hours.',
        price: 1000,
      },
      {
        id: 'gold',
        name: 'Gold',
        description: 'Premium support with 24/7 coverage and dedicated support manager.',
        price: 2000,
      },
      {
        id: 'platinum',
        name: 'Platinum',
        description: 'Highest tier with immediate response, dedicated team, and proactive monitoring.',
        price: 3000,
      }
    ],
    defaultTier: 'silver',
