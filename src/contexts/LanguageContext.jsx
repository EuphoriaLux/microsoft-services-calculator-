...
const translations = {
  en: {
    ...
    quarterly: "Quarterly",
    yearly: "Yearly",
    monthlySaving: "Pay monthly",
    quarterlySaving: "Save 5% with quarterly billing",
    yearlySaving: "Save 15% with annual billing",
    bronze: "Bronze",
    silver: "Silver",
    gold: "Gold",
    platinum: "Platinum"
  ...
  fr: {
    ...
    yearly: "Annuel",
    monthlySaving: "Paiement mensuel",
    quarterlySaving: "Économisez 5% avec facturation trimestrielle",
    yearlySaving: "Économisez 15% avec facturation annuelle",
    bronze: "Bronze",
    silver: "Argent",
    gold: "Or",
    platinum: "Platine"
  ...
  de: {
    ...
    selectBillingPeriod: "Abrechnungszeitraum auswählen",
    monthly: "Monatlich",
    quarterly: "Vierteljährlich",
    yearly: "Jährlich",
    monthlySaving: "Monatliche Zahlung",
    quarterlySaving: "Sparen Sie 5% mit vierteljährlicher Abrechnung",
    yearlySaving: "Sparen Sie 15% mit jährlicher Abrechnung",
    bronze: "Bronze",
    silver: "Silber",
    gold: "Gold",
    platinum: "Platin"
